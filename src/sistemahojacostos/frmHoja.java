...
public class frmHoja extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnnewleaf = new javax.swing.JButton();
        ...
        getContentPane().add(btnBorrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, -1, -1));

        btnnewleaf.setText("Nueva Hoja");
        btnnewleaf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnnewleafActionPerformed(evt);
            }
        });
        getContentPane().add(btnnewleaf, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 10, -1, -1));
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        if (!txtCodigoHoja.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Ya se le asignó código");
        } else {
    ...
    private void btnnewleafActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnewleafActionPerformed
    ...
    }//GEN-LAST:event_btnnewleafActionPerformed
    ...
    private javax.swing.JButton btnnewleaf;
